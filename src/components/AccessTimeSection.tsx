    ...
    <section className="relative py-24 bg-caveira-black">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center animate-fade-in">
        ...
        <div className="bg-caveira-steel/30 border-2 border-caveira-gold/30 rounded-2xl p-10 backdrop-blur-sm max-w-3xl mx-auto">
          <p className="text-xl md:text-2xl text-caveira-white leading-relaxed mb-4 text-left">
            Você terá o prazo de <span className="text-caveira-gold font-bold">6 (seis) meses</span> ou até a <span className="text-caveira-gold font-bold">data da prova</span>, o que ocorrer primeiro.
          </p>
          <p className="text-lg text-caveira-gray leading-relaxed mb-4 text-left">
          ...
          <p className="text-lg text-caveira-gray leading-relaxed text-left">
