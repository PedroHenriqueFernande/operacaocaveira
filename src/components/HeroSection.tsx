...
export const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-caveira-black">
      ...
      <div className="relative z-10 container mx-auto px-4 flex flex-col md:flex-row items-center md:items-start justify-center min-h-screen">
        {/* Left Column (60%) */}
        <div className="w-full md:w-3/5 flex flex-col items-center md:items-start text-center md:text-left pr-4">
          <div className="max-w-3xl md:mx-0 animate-fade-in">
            {/* Badge - Luxury Metallic */}
            <div className="relative inline-flex items-center gap-2 px-6 py-3 rounded-full mb-8 overflow-hidden group">
          ...
          <div className="max-w-3xl md:mx-0 animate-fade-in">
            {/* Instructor Info */}
            <p className="text-lg text-caveira-white mb-12 max-w-full" style={{ animationDelay: '0.5s' }}>
            ...
            {/* CTA Button */}
            <button className="group relative px-12 py-6 rounded-lg font-black text-xl uppercase tracking-wider transition-all duration-300 animate-fade-in flex items-center gap-3 md:mx-0 overflow-hidden" style={{ animationDelay: '0.6s', boxShadow: 'var(--shadow-gold-intense)' }}>
        ...
        {/* Right Column (40%) */}
        <div className="w-full md:w-2/5 flex items-center justify-center mt-12 md:mt-0 md:pl-4 animate-fade-in-right">
          {/* Instructor Photo */}
