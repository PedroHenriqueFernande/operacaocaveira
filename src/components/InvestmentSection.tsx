    ...
    <section className="relative py-24 bg-caveira-black">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center animate-fade-in">
        ...
        <div className="bg-caveira-steel/30 border-2 border-caveira-gold/30 rounded-2xl p-10 backdrop-blur-sm max-w-3xl mx-auto">
          ...
          {/* CTA Button */}
          <a href="#oferta">
            <Button className="group relative px-10 py-6 md:px-12 md:py-6 rounded-lg font-black text-xl md:text-xl uppercase tracking-wider transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2 md:gap-3 mx-auto overflow-hidden whitespace-nowrap" style={{ boxShadow: 'var(--shadow-gold-intense)' }}>
