import { Award, Clock, Infinity, Lock, MessageCircle, Trophy } from "lucide-react";

const benefits = [
  {
    icon: Infinity,
    title: "Acesso Vitalício",
    description: "Assista quantas vezes quiser, sem prazo de validade"
  },
  {
    icon: Clock,
    title: "Estude no Seu Ritmo",
    description: "Aulas disponíveis 24/7, de qualquer dispositivo"
  },
  {
    icon: Trophy,
    title: "Método Aprovado",
    description: "Sistema testado e validado por milhares de alunos"
  },
  {
    icon: MessageCircle,
    title: "Suporte Exclusivo",
    description: "Tire suas dúvidas diretamente com o professor"
  },
  {
    icon: Award,
    title: "Certificado",
    ...
    <section className="relative py-24 overflow-hidden" style={{ background: 'var(--gradient-steel)' }}>
      ...
      <div className="relative container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          <span className="text-caveira-gold font-bold text-sm tracking-widest uppercase" style={{ textShadow: 'var(--shadow-gold)' }}>Treinamento da Tropa</span>
          <h2 className="text-4xl md:text-6xl font-black mt-2 mb-4">
            O QUE VOCÊ <span style={{ 
